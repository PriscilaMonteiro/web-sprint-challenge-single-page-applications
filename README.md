...
`useRouteMatch` hook is used for adding nested routes to your application such that you can change a single parameter in the URL without having to change the whole thing.

1. How would you explain form validation to someone who has never programmed before?

Validation is a way to insure the quality of data. Through validation you guarantee that email addresses, passwords, strings, numbers and more have enough information and proper formats. (Yup is a good library that deals with validation)

1. In 1-2 sentences, define end to end testing.

End to end tests is a way to mimic how a user might interact with an app simulating real events and pointing out all the bugs that a user would encounter while using your website. (you could use the testing tool called Cypress)
